...
Public Class LatihanPertemuan5
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        MessageBox.Show(DatePickTanggalLahir.Value.ToString("dd/MM/yyyy"))
    End Sub
    ...
    Private Sub BtnOpenFoto_Click(sender As Object, e As EventArgs) Handles BtnOpenFoto.Click
        ...
        OpenFileDialog2.Filter = "Image|*.bmp|Image JPG|*.jpg|Imahe JPEG|*.JPEG|Image PNG|*.png|Image GIF|*.gif|All Format|*.*"
    ...
    Private Sub BtnChangeColor_Click(sender As Object, e As EventArgs) Handles BtnChangeColor.Click
        ...
        If Colors = Windows.Forms.DialogResult.OK Then
            ...
            TxtColorMode.Text = ColorDialog1.Color.ToArgb
